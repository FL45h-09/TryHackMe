...
....................................................................
====================================================================
#Day 22	: Elf McEager becomes CyberElf - Story:
...
there is a hash in the folder name:
so we search crack the hash using cyberchef website: so we found our 1sr answer.

and it was encoded with base64.

now lets open the keepass with the password we found.

now we need to crack elf server.
we used cybershef magic recipe to crack 

now we need to find the password for elf server:
This the hash
&#105;&#99;&#51;&#83;&#107;&#97;&#116;&#105;&#110;&#103;&excl;

lets crack it using the cyberchef.

now we need to find the last password.

so we found one account in recycle bin of keepass software.

there is no password but there is something in notes.

the following string we found in the notes:
...
This is the javaScript string with asccii charactors.
and there is hint in the 1st line that is fromChar.
so lets search the from char recipe and drag it.

now we need to specify the delimeter as comma and the base as 10.

now we found some decoded code but its still not valuable to us.
so lets bring another froCHar recipe and set the delimeter and base as before.

and now we found 1 website link there so lets go on that link which is github's link.

and finnaly we found our flag there.
